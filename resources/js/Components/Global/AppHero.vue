...
<template>
  <section
    class="lg:min-h-screen w-full bg-center bg-no-repeat bg-[url(/storage/hero_images/hero1.webp)] bg-gray-500 bg-blend-multiply mb-8"
  >
    <div
    ...
    >
      ...
      <!-- Search Bar -->
      <HomeSearchBar :restaurants="restaurants" :filters="filters" />
    </div>
  </section>
</template>
