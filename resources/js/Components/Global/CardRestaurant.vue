...
<template>
  <div>
    <Link
      ...
      class="w-full flex flex-col sm:flex-row rounded-md border border-gray-200 dark:border-gray-600 hover:shadow-[0_0_20px_4px_#eee] dark:hover:shadow-[0_0_20px_4px_#333] dark:text-white dark:bg-gray-900 dark:hover:bg-gray-800"
    >
      <img
        :src="imgSrc"
        :alt="restData.restName"
        class="w-full sm:w-[10rem] aspect-video sm:aspect-square object-cover rounded-t-md sm:rounded-tr-none sm:rounded-s-md"
        loading="lazy"
      />
